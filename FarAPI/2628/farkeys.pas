(*
  ...
  Inside KeyName for FAR Manager 1.75 build 2628
...
const
   ...
   KEY_NUMDEL              = $00000209;
   KEY_DECIMAL             = $0000020A;
   KEY_NUMENTER            = $0000020B;
 ...
 const
   ...
   KEY_CTRLNUMENTER         = KEY_CTRL or KEY_NUMENTER;
   KEY_SHIFTNUMENTER        = KEY_SHIFT or KEY_NUMENTER;
   KEY_ALTSHIFTNUMENTER     = KEY_ALT or KEY_SHIFT or KEY_NUMENTER;
   KEY_CTRLALTNUMENTER      = KEY_CTRL or KEY_ALT or KEY_NUMENTER;
   KEY_CTRLSHIFTNUMENTER    = KEY_CTRL or KEY_SHIFT or KEY_NUMENTER;
